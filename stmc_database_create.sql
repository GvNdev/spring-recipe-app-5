...
create table notes (id bigint not null auto_increment, recipe_id bigint, recipe_notes longtext, primary key (id)) engine=InnoDB;
create table recipe (cook_time integer, prep_time integer, servings integer, id bigint not null auto_increment, notes_id bigint, description varchar(255), source varchar(255), url varchar(255), difficulty enum ('EASY','HARD','KIND_OF_HARD','MODERATE'), directions longtext, image longblob, primary key (id)) engine=InnoDB;
